...
import com.wildcatcloud.wildcat.common.security.util.ConcurrentDateFormat;
 ...
 * @author L.cm
 */
public class WildCatFeignErrorDecoder extends ErrorDecoder.Default {
    ...
    public Exception decode(String methodKey, Response response) {
        WildCatFeignException exception = errorStatus(methodKey, response);
    ...
    private static WildCatFeignException errorStatus(String methodKey, Response response) {
        try {
            if (response.body() != null) {
                Reader reader = response.body().asReader();
                return new WildCatFeignException(Result.builder()
        ...
        return new WildCatFeignException(message);
    }
